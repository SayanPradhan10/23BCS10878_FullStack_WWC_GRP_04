...
class Main {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Student("S1", "Aarpan", 88));
        list.add(new Student("S2", "Aman", 89));
        list.add(new Student("S3", "Druv", 78));
        list.add(new GraduateStudent("S4", "Ankush", 68, "CSE"));
        list.add(new GraduateStudent("S5", "Vicky", 88, "MBA"));

        list.add(new HonourGraduateStudent("S6", "Sayan", 85, 10));
